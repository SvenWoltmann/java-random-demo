# Java Random Number Generation Demo

[![Build](https://github.com/SvenWoltmann/java-random-demo/actions/workflows/build.yml/badge.svg)](https://github.com/SvenWoltmann/java-random-demo/actions/workflows/build.yml)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=SvenWoltmann_java-random-demo&metric=coverage)](https://sonarcloud.io/dashboard?id=SvenWoltmann_java-random-demo)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=SvenWoltmann_java-random-demo&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=SvenWoltmann_java-random-demo)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=SvenWoltmann_java-random-demo&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=SvenWoltmann_java-random-demo)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=SvenWoltmann_java-random-demo&metric=security_rating)](https://sonarcloud.io/dashboard?id=SvenWoltmann_java-random-demo)
